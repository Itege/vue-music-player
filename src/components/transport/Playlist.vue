<template>
	<div>
		...
		<div v-if="tracklist.length > 0 && showPlaylist" class="playlist absolute bg-white border bottom-28 h-96 md:right-8 md:left-auto right-0 left-0 rounded-md p-4 md:w-1/3 w-full shadow-md">
