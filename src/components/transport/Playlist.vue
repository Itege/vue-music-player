<template>
	<div>
		...
		<div v-if="tracklist.length > 0 && showPlaylist" class="playlist absolute bg-white border bottom-24 h-1/2 lg:right-8 lg:left-auto right-0 left-0 rounded-md p-4 lg:w-1/3 w-full shadow-md">
